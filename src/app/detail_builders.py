...
# Brand tints live in the chip border and fill; the label itself must stay
# readable, so it tracks the theme text token instead of a fixed light tint.
_DETAIL_LINK_ACCENT_CLASSES = "text-[var(--color-text)]"
